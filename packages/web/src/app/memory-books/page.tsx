...
export default function MemoryBooksPage() {
  ...
  const handleGenerate = async (bookId: string) => {
    ...
    try {
      ...
      setError('Failed to generate personal book');
      setGenerating(null);
    }
  };
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-12 animate-fade-in">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Personal Reading Books</h1>
            <p className="text-sm text-gray-500 mt-1">Your unique reading journeys, woven into books</p>
          </div>
        </div>
      </div>
      ...
      {!loading && memoryBooks.length > 0 && (
        <div className="mb-8">
          <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-3">Your Books</h2>
      ...
      {!loading && memoryBooks.length === 0 && eligibleBooks.length === 0 && (
        <div className="text-center py-16">
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">No Personal Reading Books Yet</h2>
          <p className="text-sm text-gray-500 mb-6 max-w-md mx-auto">
            Start reading and making highlights to build your first Personal Reading Book — a unique book crafted from your reading journey.
          </p>
