    ...
    return (
      <div className="min-h-screen bg-stone-50 dark:bg-gray-950 flex items-center justify-center">
        <div className="text-center max-w-md px-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Knowledge Graph</h1>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            The knowledge graph connects concepts across all your books, revealing hidden relationships and cross-book themes.
          </p>
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4 text-sm text-gray-500 dark:text-gray-400">
            <p className="font-medium text-gray-700 dark:text-gray-300 mb-2">Setup Required</p>
            <p>Connect a Neo4j database to enable knowledge graph features. As you read and annotate, concepts will be automatically extracted and linked.</p>
          </div>
          <button
  ...
  if (!loading && neo4jAvailable && nodes.length === 0) {
    return (
      <div className="min-h-screen bg-stone-50 dark:bg-gray-950 flex items-center justify-center">
        <div className="text-center max-w-md px-6">
          <div className="text-5xl mb-4">📚</div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Building Your Graph</h1>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Start reading and annotating to build your knowledge graph. Concepts will appear as you engage with books.
          </p>
          <button
            onClick={() => router.push('/library')}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
            <div className="p-3 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Concept Map</span>
              <span className="text-xs text-gray-400">Click a node to explore connections</span>
            </div>
            {loading ? (
          ...
          <div className="space-y-4">
            ...
            {selectedNode && (
              <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4">
                ...
                {selectedNode.bookTitle && (
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">From: {selectedNode.bookTitle}</p>
                )}
            ...
            {themes.length > 0 && (
              <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Cross-Book Themes</h3>
                    ...
                    <div key={theme.conceptId} className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                          Found in {theme.bookTitles.length} book{theme.bookTitles.length !== 1 ? 's' : ''}
                        </p>
                      </div>
                    </div>
                  ))}
