 ...
 <main className="px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
  ...
  <div className="mb-8 p-4 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 rounded-xl text-red-700 dark:text-red-300 text-sm animate-slide-up flex items-center justify-between">
   ...
   <button
    ...
    className="ml-4 px-3 py-1 rounded-lg bg-red-100 dark:bg-red-900/40 text-red-700 dark:text-red-300 text-xs font-medium hover:bg-red-200 dark:hover:bg-red-900/60 transition-colors"
   >
    {t('retry')}
   </button>
  </div>
  ...
  <div className="mt-5 animate-fade-in">
   <Link
   href="/stats"
   className="flex items-center justify-between p-4 rounded-xl bg-surface-0 border border-gray-200 hover:border-amber-200 dark:hover:border-amber-800 transition-colors"
   >
   <div className="flex items-center gap-3">
    ...
    <span className="text-sm font-medium text-gray-700">{t('view_detailed_stats')}</span>
   </div>
