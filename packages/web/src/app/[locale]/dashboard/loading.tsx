export default function DashboardLoading() {
 ...
 <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
  ...
  <div className="h-5 bg-surface-2 rounded-lg w-64 mt-2 animate-pulse" />
  </div>

  {/* Current reading card skeleton — matches the active user layout */}
  <div className="space-y-5 animate-fade-in">
  <div>
   <div className="h-3 bg-surface-2 rounded w-32 mb-3 animate-pulse" />
   ...
   <div className="flex items-center gap-4">
    ...
    <div className="h-4 bg-surface-2 rounded w-48 mb-2 animate-pulse" />
    <div className="h-3 bg-surface-2 rounded w-32 mb-3 animate-pulse" />
  ...
  <div className="bg-surface-0 rounded-2xl border border-surface-3 p-6 flex items-center gap-4">
   ...
   <div className="h-8 bg-surface-2 rounded w-10 mb-1 animate-pulse" />
   <div className="h-3 bg-surface-2 rounded w-16 animate-pulse" />
   </div>
  </div>
  ...
  <div className="bg-surface-0 rounded-2xl border border-surface-3 border-l-4 border-l-primary-400/30 dark:border-l-primary-600/30 p-6">
   ...
   <div className="w-7 h-7 bg-surface-2 rounded animate-pulse" />
   <div className="flex-1">
    <div className="h-3 bg-surface-2 rounded w-20 mb-2 animate-pulse" />
