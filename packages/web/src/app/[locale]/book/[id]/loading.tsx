export default function BookDetailLoading() {
 ...
 <div aria-busy="true" className="container-content px-4 sm:px-6 lg:px-8 py-6 sm:py-10 animate-fade-in">
  ...
  <div className="flex-1 min-w-0">
   <div className="h-7 bg-surface-2 rounded-lg w-3/4 mb-3 animate-pulse" />
   <div className="h-4 bg-surface-2 rounded w-1/2 mb-4 animate-pulse" />
   <div className="flex items-center gap-3 mb-4">
   <div className="h-5 bg-surface-2 rounded-full w-16 animate-pulse" />
  ...
  {Array.from({ length: 4 }).map((_, i) => (
   ...
   <div className="h-6 bg-surface-2 rounded w-12 mx-auto mb-2 animate-pulse" />
  ...
  <div className="flex gap-4 border-b border-surface-3 pb-3">
   ...
   <div key={i} className="h-5 bg-surface-2 rounded w-20 animate-pulse" />
   ))}
  </div>
