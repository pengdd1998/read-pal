...
export default function TermsPage() {
  ...
  const linkClass = 'text-amber-700 dark:text-amber-400 underline hover:text-amber-600 focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:outline-none rounded';
