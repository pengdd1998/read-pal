...
export default function LibraryPage() {
 ...
 <main className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 animate-fade-in">
  ...
  <div className="flex items-center gap-2">
   {/* Quick Search */}
   <div className="hidden sm:flex items-center bg-surface-0 rounded-xl border border-gray-200 px-3 py-2">
   <svg aria-hidden="true" className="w-4 h-4 text-gray-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
   ...
   />
   {searchQuery && (
    <button onClick={() => setSearchQuery('')} aria-label={t('clear_search')} className="min-w-[44px] min-h-[44px] flex items-center justify-center text-gray-400 hover:text-gray-600">
   ...
   {/* View Toggle */}
   <div className="flex items-center gap-1 bg-surface-1 rounded-xl p-1 border border-gray-200 animate-slide-up stagger-2">
   <button
  ...
  <div className="flex items-center bg-surface-0 rounded-xl border border-gray-200 px-3 py-2.5">
   <svg aria-hidden="true" className="w-4 h-4 text-gray-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
   </svg>
   <input
