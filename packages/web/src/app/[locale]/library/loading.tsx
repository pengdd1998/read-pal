export default function LibraryLoading() {
 ...
 <div className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 animate-fade-in">
  ...
  <div className="animate-slide-up">
   ...
   <div className="h-4 bg-gray-200 rounded-lg w-48 mt-1 animate-pulse" />
  </div>
  ...
  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-6">
   ...
   <div key={i} className="group">
    ...
    <div className="aspect-[3/4] rounded-xl bg-gradient-to-br from-gray-100 to-gray-200 animate-pulse" />
    {/* Title */}
    <div className="mt-2">
