export default function SynthesisLoading() {
 ...
 <div aria-busy="true" className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 animate-fade-in max-w-4xl mx-auto">
  ...
  <div className="h-4 skeleton rounded w-32 mb-4 animate-pulse" />

  {/* Book selector skeleton */}
  <div className="mb-4">
   <div className="h-3 skeleton rounded w-20 mb-1 animate-pulse" />
   <div className="h-10 skeleton rounded-lg animate-pulse" />
  </div>

  {/* Mode selector skeleton */}
  <div className="mb-4">
   <div className="h-3 skeleton rounded w-24 mb-2 animate-pulse" />
   <div className="flex flex-wrap gap-1.5">
   <div className="h-8 skeleton rounded-lg w-28 animate-pulse" />
   <div className="h-8 skeleton rounded-lg w-24 animate-pulse" />
   <div className="h-8 skeleton rounded-lg w-28 animate-pulse" />
   <div className="h-8 skeleton rounded-lg w-20 animate-pulse" />
   <div className="h-8 skeleton rounded-lg w-24 animate-pulse" />
   </div>
  </div>
  ...
  <div className="mb-4">
   <div className="h-3 skeleton rounded w-16 mb-1 animate-pulse" />
   <div className="h-20 skeleton rounded-lg animate-pulse" />
  </div>
