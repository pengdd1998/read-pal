export default function BookClubsLoading() {
 ...
 <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-10 animate-fade-in">
  ...
  <div>
   ...
   <div className="h-4 bg-surface-2 rounded-lg w-52 mt-2 animate-pulse" />
  </div>
  ...
  {Array.from({ length: 3 }).map((_, i) => (
   ...
   <div className="flex items-center gap-4">
    <div className="w-12 h-12 rounded-xl bg-surface-2 animate-pulse flex-shrink-0" />
    <div className="flex-1 min-w-0">
    <div className="h-5 bg-surface-2 rounded w-48 mb-2 animate-pulse" />
