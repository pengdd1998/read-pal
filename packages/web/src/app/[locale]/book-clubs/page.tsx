...
export default function BookClubsPage() {
  ...
  <section aria-label={t('pageTitle')} className="min-h-screen bg-surface-0">
   ...
   <div className="flex items-center justify-between mb-6">
    ...
    <Link
    href="/dashboard"
    className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-400 transition-colors min-h-[44px] inline-flex items-center px-2"
    >
    {t('backToDashboard')}
    </Link>
   </div>
