...
export const ApiResponseFormat = React.memo(function ApiResponseFormat() {
 const t = useTranslations('developers');

 return (
 <section>
  <h2 className="text-xl font-bold font-serif text-gray-900 mb-4">{t('response_format')}</h2>
  <div className="bg-surface-0 rounded-xl border border-surface-3 p-6 text-sm text-gray-700 space-y-3">
