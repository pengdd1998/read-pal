...
export const ApiEndpointTable = React.memo(function ApiEndpointTable() {
 ...
 return (
 <section>
  <h2 className="text-xl font-bold font-serif text-gray-900 mb-4">{t('endpoints_title')}</h2>
  ...
  className="w-full px-4 py-2 border border-surface-3 rounded-lg text-sm mb-4 bg-surface-0 text-gray-900 focus:outline-none focus:ring-2 focus:ring-amber-500"
  />
