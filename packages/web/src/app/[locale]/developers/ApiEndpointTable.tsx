...
export function ApiEndpointTable() {
 ...
 <section>
  ...
  className="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm mb-4 bg-surface-0 text-gray-900 focus:outline-none focus:ring-2 focus:ring-amber-500"
  />
