...
export const FlashcardStudy = React.memo(function FlashcardStudy({
 cards,
 currentIndex,
 showAnswer,
 reviewing,
 ...
 <main className="max-w-lg mx-auto px-4 py-12 animate-fade-in">
  ...
  <button
   ...
   className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm text-gray-500 hover:text-amber-600 hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-colors min-h-[44px] focus-visible:ring-2 focus-visible:ring-amber-400"
  >
  ...
  <div className="animate-slide-up">
   ...
   {RATINGS.map(({ value, labelKey, hint, color, focusRing }) => (
    ...
    disabled={reviewing}
    className={`flex flex-col items-center gap-0.5 px-1 py-3 rounded-xl text-xs font-semibold transition-all duration-200 hover:scale-105 active:scale-95 disabled:opacity-50 min-h-[44px] focus-visible:ring-2 focus-visible:ring-offset-2 ${focusRing} ${color}`}
    >
