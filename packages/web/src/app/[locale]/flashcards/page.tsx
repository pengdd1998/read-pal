        ...
        <div className="card text-center py-16">
          ...
          <div className="flex flex-col gap-3 max-w-xs mx-auto mb-6 text-left">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">{t('empty_step1')}</p>
            </div>
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">{t('empty_step2')}</p>
            </div>
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">{t('empty_step3')}</p>
            </div>
          </div>
          <Link
            href="/library"
      ...
      <main className="max-w-lg mx-auto px-4 py-12 animate-fade-in">
        <div className="card text-center py-16">
          ...
          <p className="text-sm text-gray-500 mb-6">
            {t('review_complete_desc', { count: cards.length })}
          </p>
    ...
    return (
      ...
      <main className="max-w-lg mx-auto px-4 py-12 animate-fade-in">
        ...
        {deckTotalDue > 0 && (
          ...
          >
            {t('review_all', { count: deckTotalDue })}
          </button>
        )}
