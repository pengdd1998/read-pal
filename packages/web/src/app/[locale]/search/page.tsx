    ...
    <div className="max-w-4xl mx-auto px-3 sm:px-6 py-6 sm:py-8">
      ...
      {searched && hasResults && (
        <div className="flex gap-2 mb-5">
          {([
            { key: 'all' as const, label: t('filter_all'), count: results.length + highlights.length + passages.length },
            { key: 'books' as const, label: t('filter_books'), count: results.length },
            { key: 'passages' as const, label: t('filter_passages'), count: passages.length },
            ...
            {filteredPassages.length > 0 && (
              <div>
                <h2 className="text-sm font-semibold text-gray-400 uppercase tracking-wide mb-3">
                  {t('passages_heading', { count: filteredPassages.length })}
                </h2>
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 mt-2 text-xs text-gray-400">
                            ...
                            <span>&middot;</span>
                            <span>{t('match_percent', { percent: Math.round(p.score * 100) })}</span>
                          </div>
                        </div>
                      </div>
                    </Link>
