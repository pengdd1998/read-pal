  ...
  return (
    <div className="min-h-screen bg-surface-1">
      ...
      <div className="border-b border-surface-3 bg-surface-0">
        <div className="container-content px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-[28px] font-bold text-gray-900 dark:text-gray-100">{t('header_title')}</h1>
      ...
      <div className="container-content px-4 sm:px-6 lg:px-8 py-6">
