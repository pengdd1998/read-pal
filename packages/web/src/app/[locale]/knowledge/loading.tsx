 ...
 <div aria-busy="true" className="min-h-screen bg-surface-1">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
   ...
   <div className="h-[420px] relative bg-surface-1">
    ...
    <line x1="300" y1="180" x2="460" y2="120" stroke="var(--gray-200)" strokeWidth="1.5" opacity="0.5" />
    <line x1="460" y1="120" x2="500" y2="280" stroke="var(--gray-200)" strokeWidth="1.5" opacity="0.5" />
    <line x1="200" y1="300" x2="350" y2="350" stroke="var(--gray-200)" strokeWidth="1.5" opacity="0.5" />
    <line x1="120" y1="100" x2="80" y2="250" stroke="var(--gray-200)" strokeWidth="1.5" opacity="0.5" />
    <line x1="500" y1="280" x2="350" y2="350" stroke="var(--gray-200)" strokeWidth="1.5" opacity="0.5" />
