    ...
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-950 px-6 py-12">
      <div className="text-center max-w-md w-full animate-fade-in">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-6">
          {isOnline
            ? 'Your connection has been restored. Head back to your reading.'
            : 'Check your internet connection. Any reading progress has been saved locally.'}
        </p>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-gray-400">
                            {book.chaptersCached}/{book.totalChapters} chapters cached
                          </p>
                        </div>
                      </a>
                    ))}
        ...
        {!isOnline && (
          <div className="mt-8 p-4 rounded-xl bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800/30 text-left">
            <p className="text-xs font-medium text-amber-700 dark:text-amber-300 mb-2">Offline Tips</p>
            <ul className="text-xs text-amber-600/80 dark:text-amber-400/80 space-y-1">
              <li>• Highlights and notes are saved and synced when you reconnect</li>
              <li>• Books you&apos;ve opened before are available for offline reading</li>
              <li>• Your reading streak is tracked even while offline</li>
            </ul>
          </div>
        )}
      </div>
