 ...
 <div className="card shadow-soft">
  ...
  <div>
   ...
   <button
    ...
    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 min-w-[44px] min-h-[44px]"
