...
export const ReadingSpeed = React.memo(function ReadingSpeed({ speedData, bookSpeeds }: ReadingSpeedProps) {
...
const WpmTrend = React.memo(function WpmTrend({ data }: { data: SpeedData }) {
 ...
 <div className="mb-5">
  ...
  <span className="text-sm text-gray-600 dark:text-gray-300">{t('speed_trend')}</span>
  </div>
