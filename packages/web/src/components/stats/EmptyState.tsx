...
export const EmptyState = React.memo(function EmptyState() {
 ...
 <div className="text-center py-16 animate-fade-in">
  ...
  <Link
  href="/library"
  className="inline-flex items-center justify-center gap-2 px-5 py-3 min-h-[44px] bg-amber-600 hover:bg-amber-700 text-white font-medium rounded-xl transition-colors text-sm focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-1"
  >
