 ...
 <div className="py-8">
  ...
  {coverUrl && (
   ...
   <Image
    ...
    fill
    sizes="100px"
    className="object-cover rounded-lg shadow-[0_4px_12px_-2px_rgba(30,42,56,0.1),0_8px_24px_-4px_rgba(30,42,56,0.06)] dark:shadow-[0_4px_12px_-2px_rgba(0,0,0,0.3),0_8px_24px_-4px_rgba(0,0,0,0.2)]"
   />
   </div>
  )}
  <div>
  ...
  <div className="flex flex-wrap gap-3 pt-4 border-t border-amber-100">
   <div className="bg-surface-0 border border-amber-100 rounded-lg px-3 py-2 text-center min-w-[100px]">
