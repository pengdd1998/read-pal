...
export const ShareDialog = React.memo(function ShareDialog({
 ...
 >
  ...
  <div className="px-5 py-4 border-b border-surface-3 flex items-center justify-between">
   ...
   className="p-1.5 rounded-lg text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-400 hover:bg-surface-1 focus-visible:ring-2 focus-visible:ring-amber-400"
   >
