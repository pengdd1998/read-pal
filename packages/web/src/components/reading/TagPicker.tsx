 ...
 return (
  ...
  <div className="flex flex-wrap gap-2">
   ...
   <button type="button"
    ...
    className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-surface-1 border border-surface-3 text-xs font-medium text-gray-700 active:scale-95 transition-all hover:border-amber-300 dark:hover:border-amber-700 focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-1"
   >
