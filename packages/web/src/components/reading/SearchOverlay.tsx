 ...
 >
  ...
  <div className="bg-surface-0 rounded-2xl shadow-xl border border-surface-3 overflow-hidden">
   ...
   <button
    ...
    aria-label={t('search_close')}
    className="p-2.5 rounded-lg text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
   >
