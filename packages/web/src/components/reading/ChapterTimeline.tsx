 ...
 <div className="fixed inset-0 z-40 bg-black/30 animate-fade-in" onClick={onClose} onKeyDown={handleBackdropKey} role="dialog" aria-modal="true" aria-label={t('timeline_title')} tabIndex={-1}>
  ...
  <div className="p-4 space-y-1.5">
   ...
   <div className="flex flex-col items-center gap-3 py-8 text-center">
    ...
    <button type="button" onClick={loadStats} disabled={loading} className="px-4 py-2 text-xs font-medium rounded-lg bg-amber-500 text-white hover:bg-amber-600 transition-colors focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed min-h-[44px] inline-flex items-center">
     {t('timeline_retry')}
    </button>
   </div>
   ) : (
