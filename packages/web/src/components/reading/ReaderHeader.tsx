...
export function ReaderHeader(props: ReaderHeaderProps) {
 ...
 <div className={`relative z-40 flex items-center justify-between px-2 sm:px-3 h-12 backdrop-blur-md ${HEADER_CLASSES[theme]} border-b shrink-0`}>
  ...
  <button onClick={onBack} className="w-9 h-9 flex items-center justify-center rounded-lg text-gray-400 hover:text-gray-600 hover:bg-gray-100/60 transition-all active:scale-95" aria-label={t('back_to_library_label')}>
