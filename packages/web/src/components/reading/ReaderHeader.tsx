  ...
  return (
    <div className={`relative z-40 flex items-center justify-between px-3 py-2 backdrop-blur-sm ${HEADER_BG_CLASSES[theme]} shrink-0 border-b`}>
      ...
      <div className="flex items-center gap-0.5 flex-shrink-0">
        ...
        {/* Reading Plan */}
        <button onClick={onToggleReadingPlan} className={`w-11 h-11 hidden sm:flex items-center justify-center rounded-lg text-sm transition-colors ${readingPlanOpen ? 'bg-amber-100 dark:bg-amber-900/40 text-amber-700 dark:text-amber-300' : 'text-gray-400 hover:text-amber-600 hover:bg-amber-50 dark:hover:bg-amber-900/20'}`} aria-label={t('reading_plan_title')}>
          <svg className="w-[18px] h-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
