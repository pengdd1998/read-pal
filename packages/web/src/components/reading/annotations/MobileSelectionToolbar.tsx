...
import { TagPicker } from '../core/TagPicker';
...
export const MobileSelectionToolbar = memo(function MobileSelectionToolbar({
 ...
 >
  ...
  <div className="flex items-center justify-around px-4 py-3">
   ...
   >
    <div className="w-11 h-11 rounded-xl bg-gradient-to-r from-amber-500 to-amber-400 flex items-center justify-center shadow-sm">
