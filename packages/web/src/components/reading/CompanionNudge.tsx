...
export const CompanionNudge = React.memo(function CompanionNudge() {
 ...
 <div className="fixed bottom-24 right-6 z-10 animate-fade-in max-w-[220px]" role="status" aria-live="polite">
  ...
  <div className="flex items-start gap-2">
   ...
   <button onClick={handleDismiss} className="text-teal-400 hover:text-teal-600 dark:hover:text-teal-300 transition-colors flex-shrink-0 -mt-0.5 p-1 min-w-[44px] min-h-[44px] flex items-center justify-center" aria-label={t('dismiss_label')}>
