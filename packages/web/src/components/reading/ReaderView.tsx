 ...
 >
  ...
  >
   ...
   <div className="text-center py-16 px-4">
    <svg aria-hidden="true" className="w-10 h-10 mx-auto mb-4 text-gray-400 dark:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    <p className="text-gray-400 dark:text-gray-500 text-xs">{t('empty_chapter_hint')}</p>
   </div>
   ) : (
   <div
   ref={(el) => {
