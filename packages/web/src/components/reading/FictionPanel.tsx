    ...
    <>
      ...
      {isOpen && (
        <>
          ...
          <div className="fixed left-0 bottom-0 z-50 w-full md:left-6 md:bottom-20 md:w-80 md:max-h-[70vh] bg-surface-0 shadow-2xl rounded-t-2xl md:rounded-2xl border border-purple-200/50 dark:border-purple-800/30 flex flex-col animate-slide-in-up md:animate-fade-in max-h-[60vh]">
            {/* Header */}
