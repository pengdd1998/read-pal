 ...
 <div role="status" aria-live="polite" className="fixed bottom-20 left-1/2 -translate-x-1/2 z-30 max-w-sm w-full px-4 animate-fade-in">
  ...
  <div className="flex items-start gap-3">
   ...
   <div className="flex items-center gap-2 mt-2">
    ...
    disabled={submitting}
    className="text-xs text-gray-500 hover:text-gray-600 transition-colors disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-1"
    >
    {t('dismiss')}
    </button>
   </div>
   ...
   <button type="button"
   onClick={handleDismiss}
   className="text-gray-400 hover:text-gray-600 transition-colors focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-1 flex-shrink-0 p-2 -m-2 min-h-[44px] min-w-[44px] inline-flex items-center justify-center"
