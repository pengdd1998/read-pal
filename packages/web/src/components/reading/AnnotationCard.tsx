...
export const AnnotationCard = memo(function AnnotationCard({ annotation, bookTitle, author, onDelete, onUpdate, onClick }: AnnotationCardProps) {
 ...
 >
  ...
  {/* Note */}
  {annotation.note && (
  <div className="mt-2 px-2.5 py-1.5 rounded-md bg-white/50 text-xs text-gray-600 dark:text-gray-400 border border-surface-3">
   {annotation.note}
  </div>
  )}
  ...
  <div className="flex flex-wrap gap-1 mt-2">
   ...
   <span
    ...
    tag === 'discuss'
     ...
     : 'bg-surface-2 text-gray-600 dark:text-gray-400'
    }`}
   >
    #{tag}
   </span>
