...
export const ShareDiscussionTab = React.memo(function ShareDiscussionTab({
  ...
  const handleGenerateGuide = useCallback(async () => {
    ...
    try {
      ...
      const { generateDiscussionGuideHtml } = await import('@/lib/render/export-discussion-guide');
  ...
  const handleCopyGuide = useCallback(async () => {
    if (!guideHtml) return;
    const { copyDiscussionGuide } = await import('@/lib/render/export-discussion-guide');
  ...
  const handleDownloadGuide = useCallback(async () => {
    if (!guideHtml) return;
    const { downloadDiscussionGuide } = await import('@/lib/render/export-discussion-guide');
  ...
  const handlePrintGuide = useCallback(async () => {
    if (!guideHtml) return;
    const { printDiscussionGuide } = await import('@/lib/render/export-discussion-guide');
