...
export function NodeDetailPanel({ node, connectedEdges, allNodes, onDeselect, t }: NodeDetailPanelProps) {
  ...
  return (
    <div className="bg-surface-0 rounded-xl border border-gray-200 dark:border-gray-800 p-4">
      <div className="flex items-center gap-2 mb-2">
        <h3 className="font-semibold text-gray-900 dark:text-white">{node.label}</h3>
