...
export function SynthesizeForm({
 ...
 <div className="space-y-3">
  ...
  <textarea
   ...
   rows={3}
   className="w-full px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-800 border border-surface-3 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 outline-none focus:ring-1 focus:ring-amber-400/50 focus:border-amber-400 transition-all resize-none"
  />
  </div>
  <div>
