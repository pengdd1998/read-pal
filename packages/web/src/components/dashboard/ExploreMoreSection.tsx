...
export const ExploreMoreSection = React.memo(function ExploreMoreSection() {
 ...
 <div className="mt-10 pt-6 border-t border-surface-2 animate-fade-in">
  <p className="text-xs text-gray-500 font-medium uppercase tracking-wide mb-3">{t('explore_more')}</p>
  ...
  <Link
   href="/memory-books"
   className="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-violet-600 dark:hover:text-violet-400 transition-colors"
  >
   <svg aria-hidden="true" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  <Link
   href="/stats"
   className="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
  >
   <svg aria-hidden="true" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  <Link
   href="/flashcards"
   className="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-teal-600 dark:hover:text-teal-400 transition-colors"
  >
   <svg aria-hidden="true" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  <Link
   href="/book-clubs"
   className="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-amber-600 dark:hover:text-amber-400 transition-colors"
  >
   <svg aria-hidden="true" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
