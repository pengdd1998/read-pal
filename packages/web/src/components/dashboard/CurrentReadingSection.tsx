   ...
   {activeBooks.map((book, i) => (
    ...
    <div className="flex items-center gap-4">
     ...
     <div className="flex items-center gap-3 mt-2">
      ...
      <div className="w-full bg-surface-1 rounded-full h-2" role="progressbar" aria-label={t('reading_progress')} aria-valuenow={Math.round(book.progress)} aria-valuemin={0} aria-valuemax={100}>
       <div
