...
function Skeleton() {
 ...
 <div className="rounded-2xl border border-surface-2 bg-surface-0 p-5 sm:p-6 shadow-sm">
  <div className="h-5 w-32 skeleton rounded animate-pulse mb-4" />
  <div className="space-y-3">
  {[1, 2].map((i) => (
   <div key={i} className="flex items-center gap-3">
   <div className="w-10 h-10 rounded-lg skeleton animate-pulse" />
   <div className="flex-1">
    <div className="h-4 w-28 skeleton rounded animate-pulse mb-1" />
