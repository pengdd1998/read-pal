...
export const ReadingGoalsWidget = memo(function ReadingGoalsWidget() {
 ...
 return (
  ...
  <button onClick={fetchGoals} className="min-h-[44px] inline-flex items-center text-xs text-amber-600 dark:text-amber-400 hover:underline focus-visible:ring-2 focus-visible:ring-amber-400">{t('retry')}</button>
  </div>
 );
 }
