...
export const DashboardChallenges = memo(function DashboardChallenges() {
 ...
 return (
  ...
  <button onClick={fetchChallenges} className="min-h-[44px] inline-flex items-center text-xs text-amber-600 dark:text-amber-400 hover:underline">{t('retry')}</button>
  </div>
 );
 }
