...
export const ReadingGoals = React.memo(function ReadingGoals() {
 ...
 <div className="rounded-2xl border border-surface-2 bg-surface-0 p-6">
  ...
  {!editingGoal ? (
   ...
   className="flex items-center gap-1.5 text-xs text-gray-400 dark:text-gray-500 hover:text-primary-600 dark:hover:text-primary-400 transition-colors mx-auto min-h-[44px] px-3 focus-visible:ring-2 focus-visible:ring-amber-400">
   ...
   <div className="flex items-center gap-3">
    ...
    className="w-11 h-11 rounded-lg bg-surface-1 text-gray-600 dark:text-gray-400 flex items-center justify-center hover:bg-surface-2 disabled:opacity-40 disabled:cursor-not-allowed transition-colors focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:ring-offset-1">
   ...
   <div className="flex items-center gap-2">
    ...
    className="px-3 py-1.5 text-xs font-medium rounded-lg bg-surface-1 text-gray-600 dark:text-gray-400 hover:bg-surface-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors min-h-[44px] focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2">
    {t('goals_cancel')}
    </button>
   </div>
