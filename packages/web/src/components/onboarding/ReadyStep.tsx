    ...
    <div className="text-center">
      ...
      <div className="flex flex-col gap-3 max-w-xs mx-auto">
        ...
        <button type="button"
          onClick={onFinish}
          disabled={saving}
          className="px-4 py-2 text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-400 transition-colors focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-1"
        >
