...
export const LibraryFilterBar = React.memo(function LibraryFilterBar({
 ...
 <div className="flex flex-col sm:flex-row gap-3 animate-slide-up">
  ...
  {searchQuery && (
   ...
   className="absolute top-1/2 -translate-y-1/2 right-0 min-w-[44px] min-h-[44px] flex items-center justify-center text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-1"
   >
