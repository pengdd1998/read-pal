...
export const LoadingSpinner = memo(function LoadingSpinner({ className = 'w-4 h-4' }: { className?: string }) {
 const t = useTranslations('common');
 return (
 <svg role="status" aria-label={t('loading')} className={`${className} animate-spin`} viewBox="0 0 24 24" fill="none">
