  ...
  <div className="px-4 sm:px-6 lg:px-8">
   ...
   <div className="flex items-center gap-1 sm:gap-3 min-w-0">
    ...
    <>
     ...
     <button type="button" onClick={() => { if (typeof window === 'undefined') return; const isDark = document.documentElement.classList.toggle('dark'); localStorage.setItem('theme', isDark ? 'dark' : 'light'); }}
