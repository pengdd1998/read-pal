 ...
 <div className="min-h-screen flex flex-col bg-surface-1">
  ...
  <div className="px-4 sm:px-6 lg:px-8">
   ...
   <div className="flex items-center gap-1 sm:gap-3 min-w-0">
    {mounted && isAuthenticated ? (
    <>
     <Link href="/search" className="hidden md:min-w-[44px] md:min-h-[44px] md:flex items-center justify-center rounded-lg text-gray-400 hover:text-amber-600 dark:hover:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-colors" aria-label={t('nav_search')}>
     ...
     className="min-w-[44px] min-h-[44px] flex items-center justify-center rounded-lg text-gray-400 hover:text-amber-600 dark:hover:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-colors" aria-label={tc('toggle_dark_mode')}>
