...
export const StudyGuideCard = React.memo(function StudyGuideCard({
 bookId,
 book,
 flashcardCount,
 totalAnnotations,
 ...
 <div className="bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-900/10 dark:to-blue-900/10 rounded-2xl border border-indigo-200/50 dark:border-indigo-800/30 p-5 mb-6 animate-slide-up stagger-4">
  ...
  <svg aria-hidden="true" className="w-7 h-7 text-indigo-500 dark:text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
