...
export const CTASection = React.memo(function CTASection({
 ...
 <>
  {/* GitHub Star CTA */}
  <section aria-label={love_text} className="px-4 sm:px-6 lg:px-8 py-12 text-center">
  <div className="inline-flex items-center gap-4 px-6 py-4 rounded-2xl border border-surface-3 bg-surface-0 shadow-sm">
   ...
   className="inline-flex items-center gap-2 px-5 py-2.5 bg-surface-3 text-gray-800 dark:text-gray-200 font-semibold rounded-xl hover:opacity-90 transition-opacity"
   >
  ...
  <div className="relative z-10 px-4 sm:px-6 lg:px-8 text-center">
   ...
   <p className="text-sm text-white/50 mt-5">{free_during_beta}</p>
  </div>
  </section>
 </>
 );
