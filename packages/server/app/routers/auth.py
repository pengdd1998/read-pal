...
async def register(
    ...
    # Seed sample annotations so all features (KG, export, flashcards) have data
    sample_annotations = [
        Annotation(
            user_id=user.id, book_id=sample.id,
        ...
        Annotation(
            ...
            content='The eyes of Doctor T.J. Eckleburg watch over the Valley of Ashes — God watching moral decay?',
        ...
        Annotation(
            user_id=user.id, book_id=sample.id,
            type=AnnotationType.note,
            content='Gatsby\'s parties represent the excess and emptiness of the Jazz Age. Everyone comes but nobody truly knows him.',
