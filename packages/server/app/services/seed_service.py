...
async def seed_sample_data(db: AsyncSession, user_id: UUID) -> Book:
    ...
    sample_annotations = [
        ...
        Annotation(
            ...
            location={'pageIndex': 0, 'chapter': 9, 'position': 0, 'selection': {'start': 0, 'end': 80}},
        ...
        Annotation(
            ...
            location={'pageIndex': 0, 'chapter': 2, 'position': 0, 'selection': {'start': 0, 'end': 87}},
        ...
        Annotation(
            ...
            location={'pageIndex': 0, 'chapter': 2, 'position': 0, 'selection': {'start': 0, 'end': 80}},
        ...
        Annotation(
            ...
            location={'pageIndex': 0, 'chapter': 3, 'position': 0, 'selection': {'start': 0, 'end': 95}},
        ...
        Annotation(
            ...
            location={'pageIndex': 0, 'chapter': 9, 'position': 0, 'selection': {'start': 0, 'end': 74}},
        ...
        Annotation(
            ...
            location={'pageIndex': 0, 'chapter': 4, 'position': 0, 'selection': {'start': 0, 'end': 40}},
        ),
    ]
